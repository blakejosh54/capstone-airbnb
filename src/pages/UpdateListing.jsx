...
function UpdateListing() {
  ...
  useEffect(() => {
    async function fetchListing() {
      try {
        ...
        if (!response.ok) {
          setMessage(data.message || "Could not load listing.");
        ...
        setMessage("Something went wrong while loading the listing.");
      } finally {
        setPageLoading(false);
      }
    }
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      setMessage("Something went wrong while updating the listing.");
    } finally {
      setLoading(false);
    }
  }
  ...
  if (pageLoading) {
    return (
      <main className="host-page">
        <HostNav />
        <p className="host-message">Loading listing...</p>
      </main>
    );
  }
  ...
  return (
    <main className="host-page">
      ...
      <h1 className="host-title">Update Listing</h1>
